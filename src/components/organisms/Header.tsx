...
function Header() {
  return (
    <header className="bg-white shadow-sm border-b border-gray-200">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between px-6  sm:px-8 lg:px-58 py-4 gap-y-4">
        ...
        <div className="flex flex-row gap-4 text-center md:text-right">
          <span>
